...
def upgrade() -> None:
    ...
    op.create_table('badbot_configs',
    ...
    op.create_index(op.f('ix_badbot_configs_id'), 'badbot_configs', ['id'], unique=False)
    op.create_table('trusted_contacts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('badbot_config_id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['badbot_config_id'], ['badbot_configs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.add_column('calls', sa.Column('badbot_transcript', sa.Text(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('calls', 'badbot_transcript')
    ...
    op.drop_index(op.f('ix_badbot_configs_id'), table_name='badbot_configs')
    op.drop_table('badbot_configs')
    # ### end Alembic commands ###
